    ...
    <div class="container">
        <div class="row mb-5 justify-content-center">
            <div class="col-md-5 text-center">
                {!! $page->content['sectionTwo'] !!}
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-5 text-center">
                <img src="{{asset('theme/front/images/person_1.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
            ...
            <div class="col-md-6 col-lg-4 mb-5 text-center">
                <img src="{{asset('theme/front/images/person_2.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
            ...
            <div class="col-md-6 col-lg-4 mb-5 text-center">
                <img src="{{asset('theme/front/images/person_3.jpg')}}" alt="Image" class="img-fluid w-50 rounded-circle mb-4">
